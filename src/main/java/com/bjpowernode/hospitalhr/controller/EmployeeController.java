...
public class EmployeeController {
	...
	public String updateById1(@PathVariable Integer id, Employee employee, String date, String status,
							 HttpSession session){
		employee.setId(id);
		employee.setBirthday(MTimeUtil.stringParse(date));
		//得到操作人员的名字
		status="在职";
		Employee employee2 = (Employee) session.getAttribute("loged");
		employeeService.updateEmployee1(employee, status, employee2.getName());
		return "forward:/employee/listPage.do?pageNo=1";
	}
